import os
from views import display_menu, get_user_choice, display_user_management_menu, get_user_infos, another_player
...
def start_player_management():
    ...
    while user_choice == "1":
        ...
        new_player = Joueur(user_infos["Name"], user_infos["Firstname"])
